...
export function StepperModal({
  ...
  return (
    <div className="stepper-overlay" onClick={onClose} role="dialog" aria-modal="true">
        ...
        <div className="stepper-timeline" aria-label="Étapes de configuration">
          {steps.map((step, index) => {
            ...
            return (
              <div
                key={step.id}
                className={`stepper-pill ${isActive ? "is-active" : ""} ${isCompleted ? "is-completed" : ""}`}
                onClick={() => {
            ...
            <div className="stepper-footer-actions">
              ...
              {!isLastStep ? (
                ...
                <button
                  ...
                  style={{ opacity: !isCurrentStepValid ? 0.5 : 1, cursor: !isCurrentStepValid ? "not-allowed" : "pointer" }}
                >
                  Suivant
                </button>
              ) : (
