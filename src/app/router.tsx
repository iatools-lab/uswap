...
const AdminShell = lazy(() =>
  import("../shells/AdminShell").then((m) => ({ default: m.AdminShell })),
);
const RoleShell = lazy(() =>
  import("../shells/RoleShell").then((m) => ({ default: m.RoleShell })),
);

const AccountAccessPage = lazy(() =>
  import("../pages/AccountAccessPage").then((m) => ({
    default: m.AccountAccessPage,
  })),
);
...
const UserImportPage = lazy(() =>
  import("../pages/admin/UserImportPage").then((m) => ({
    default: m.UserImportPage,
  })),
);
...
const StationsPage = lazy(() =>
  import("../pages/admin/StationsPage").then((m) => ({
    default: m.StationsPage,
  })),
);
const AdminPlannerPage = lazy(() =>
  import("../pages/admin/AdminPlannerPage").then((m) => ({
...
const RolePlannerPage = lazy(() =>
  import("../pages/role/RolePlannerPage").then((m) => ({
    default: m.RolePlannerPage,
  })),
);
const SwapperLeavePage = lazy(() =>
  import("../pages/role/SwapperLeavePage").then((m) => ({
  ...
  return (
    <Routes>
      ...
      <Route
        ...
        element={<AccountRoute mode="forgot" />}
      />
      <Route path="/auth/activate" element={<AccountRoute mode="activate" />} />
      <Route
        path="/auth/reset-password"
        element={<AccountRoute mode="reset" />}
      />

      <Route
        path={rolePaths.ADMIN}
        element={<RequireAuth role="ADMIN">{page(<AdminShell />)}</RequireAuth>}
      >
